...
/**
 * @Description 客户端监听数据回调原始数据的实体属性Bean
 * @Author yoko
 * @Date 2020/7/6 16:09
 * @Version 1.0
 */
public class ClientAllDataModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1303223201155L;
