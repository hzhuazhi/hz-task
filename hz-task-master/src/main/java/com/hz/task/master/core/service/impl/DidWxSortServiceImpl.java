...
import com.hz.task.master.core.mapper.DidWxSortMapper;
import com.hz.task.master.core.model.did.DidWxSortModel;
import com.hz.task.master.core.service.DidWxSortService;
...
public class DidWxSortServiceImpl<T> extends BaseServiceImpl<T> implements DidWxSortService<T> {
    ...
    public int addByExist(DidWxSortModel model) {
        ...
        didWxSortQuery.setDid(model.getDid());
        didWxSortQuery.setToWxid(model.getToWxid());
        DidWxSortModel didWxSortModel = (DidWxSortModel)didWxSortMapper.findByObject(didWxSortQuery);
