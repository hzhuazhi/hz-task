...
import com.hz.task.master.core.service.OrderService;
...
//        }
    ...
    public List<OrderModel> getInitOrderList(OrderModel model) {
        return orderMapper.getInitOrderList(model);
    }
    ...
    public int updateOrderStatusByInvalidTime(OrderModel model) {
        return orderMapper.updateOrderStatusByInvalidTime(model);
    }

    @Override
    public List<OrderModel> getOrderByCreateTime(OrderModel model) {
        return orderMapper.getOrderByCreateTime(model);
    }

    @Override
    public int updateOrderStatusByIdList(OrderModel model) {
        return orderMapper.updateOrderStatusByIdList(model);
    }
    ...
    public int updateOrderStatusAndRemark(OrderModel model) {
        return orderMapper.updateOrderStatusAndRemark(model);
    }
