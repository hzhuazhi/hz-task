...
/**
 * @Description 接单池子正在接单的实体属性Bean
 * @Author yoko
 * @Date 2020/8/13 15:00
 * @Version 1.0
 */
public class PoolOpenModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1203223211121L;
