...
import com.hz.task.master.core.mapper.DidCollectionAccountQrCodeMapper;
import com.hz.task.master.core.model.did.DidCollectionAccountQrCodeModel;
import com.hz.task.master.core.service.DidCollectionAccountQrCodeService;
...
public class DidCollectionAccountQrCodeServiceImpl<T> extends BaseServiceImpl<T> implements DidCollectionAccountQrCodeService<T> {
    ...
    public int updateIsLimitNum(DidCollectionAccountQrCodeModel model) {
        return didCollectionAccountQrCodeMapper.updateIsLimitNum(model);
    }
}
